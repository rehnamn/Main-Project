...
# Fit the model
net2.fit(feature_train, label_train, validation_data=(feature_test, label_test), epochs=10, batch_size=200, verbose=2)
# Final evaluation of the model
loss,acc = net2.evaluate(feature_test, label_test, verbose=2)
...
with open("acc_net2.json", "w") as json_file:
